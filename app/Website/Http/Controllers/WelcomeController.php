...
class WelcomeController extends Controller
{
    public function index()
    {
        return view('pages.home', [
            ...
            'featuredProfiles' => app(HomepageProfiles::class)->get(),
            'searchCities' => app(HomepageCities::class)->get(),
        ]);
    }
    ...
    {
        $pricings = Cache::remember(config('site.current.key').':public-membership-plans', now()->addMinutes(10), function () {
